 ...
 */
define(['N/log', 'N/task', 'N/record', 'N/runtime', 'N/search'],
    /**
 * @param{log} log
 * @param{task} task
 */
    (log, task, record, runtime, search) => {
        /**
        ...
        const getInputData = (inputContext) => {
            try {
                //Se obtienen los datos directamente del parametro del script
                var objScript = runtime.getCurrentScript();
                var jsonMod = JSON.parse(objScript.getParameter({ name: "custscript_tkio_json_mod" }));
                return [jsonMod];
            } catch (Error) {
        ...
        const reduce = (reduceContext) => {
            try {
                ...
                log.debug({ title: 'Datos obtenidos del Suitelet de Servicio: ', details: data });
                ...
                log.debug({ title: 'Modificacion con exito: ', details: "" });
            } catch (e) {
